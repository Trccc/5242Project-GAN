...
def train_step(images, showloss = False):
    ...
    discriminator_new = discriminator
    
    if cfg.GAN_SN:
        for layer in discriminator_new.layers:
    ...
    gradients_of_discriminator = disc_tape.gradient(disc_loss, discriminator_new.trainable_variables)
